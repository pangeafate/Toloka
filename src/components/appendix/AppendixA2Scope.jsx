 ...
 * happens on Slide 6 in the room. A2 just shows the choice space.
 */
export default function AppendixA2Scope({ onClose }) {
  ...
  return (
    <div className="toloka-slide" style={{ justifyContent: 'space-between' }}>
      <div>
        <BackLink onClose={onClose} label="Back to Inputs (Slide 6)" />
        ...
        >
          Pilot v1 scope is set in the room at Slide 6 with you and the SMEs. This is the choice space.
        </p>
      </div>
